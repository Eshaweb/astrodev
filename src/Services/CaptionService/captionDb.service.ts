...
export class CaptionDbService {
    ...
    GetCaption(langCode: string, caption: Caption) {
       ...
       else if(langCode=="TAM")
        {
            ...
            caption.JanmaNakshthra="¦ƒýÁ ¿ðºò¾¢Ãõ";
            caption.JanmaRashi="¦ƒýÁ Ã¡º¢";
            caption.Aroodha="";
            caption.SunRise="Ý÷Â ¯¾Âõ";
            caption.Udaya="";
            caption.SunSet="ÝÃ¢Â «Š¾ÁÉõ";
            caption.Lagnamsha="";
            caption.DinaMana="¾¢É «Ç×";
            caption.ChatraRashi="";
            caption.SprushtangaRashi="";
            caption.Tambula="";
            caption.ChandradishtithaRashi="";
    
            caption.MoonRise="ºó¾¢§Ã¡¾Âõ";
            caption.MoonSet="ºó¾¢Ã «Š¾ÁÉõ"; 
            caption.Rahu="Ã¡Ì ¸¡Äõ";
            caption.Gulika="ÌÇ¢¸ ¸¡Äõ"; 
            caption.Yama="ÂÁ¡"; 
            caption.Tithi="¾¢¾¢"; 
            caption.Nak="¿ðºò¾¢Ãõ"; 
            caption.Yoga="§Â¡¸õ";
