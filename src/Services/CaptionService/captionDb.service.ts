...
export class CaptionDbService {
    ...
    GetCaption(langCode: string, caption: Caption) {
       ...
       else if(langCode=="TAM")
        {
            ...
            caption.JanmaNakshthra="ஜென்ம நட்சத்திரம்";
            caption.JanmaRashi="ஜென்ம ராசி";
            caption.Aroodha="";
            caption.SunRise="சூர்ய உதயம்";
            caption.Udaya="";
            caption.SunSet="சூரிய அஸ்தமனம்";
            caption.Lagnamsha="";
            caption.DinaMana="தின அளவு";
            caption.ChatraRashi="";
            caption.SprushtangaRashi="";
            caption.Tambula="";
            caption.ChandradishtithaRashi="";
    
            caption.MoonRise="சந்திரோதயம்";
            caption.MoonSet="சந்திர அஸ்தமனம்"; 
            caption.Rahu="ராகு காலம்";
            caption.Gulika="குளிக காலம்"; 
            caption.Yama="யமா"; 
            caption.Tithi="திதி"; 
            caption.Nak="நட்சத்திரம்"; 
            caption.Yoga="யோகம்";
            caption.Sunday="»¡Â¢Ú";
            caption.Monday="¾¢í¸û"; 
