...
@Component({
  selector: 'app-shraddhaMaasika-free-data',
  templateUrl: './shraddhaMaasika-free-data.component.html',
  styleUrls: ['./shraddhaMaasika-free-data.component.scss']
})

export class ShraddhaMaasikaFreeDataComponent {
  Name: string;
  horoInfo: any;
