...
@Component({
  selector: 'app-prathamartava-free-data',
  templateUrl: './prathamartava-free-data.component.html',
  styleUrls: ['./prathamartava-free-data.component.scss']
})

export class PrathamartavaFreeDataComponent {
  Name: string;
  horoInfo: any;
