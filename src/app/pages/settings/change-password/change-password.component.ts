...
export class ChangePasswordComponent {
    ...
    passwordMode_OldPassword: string;
    passwordMode_NewPassword: string;
    passwordMode_confirm_NewPassword: string;
    passwordButton_OldPassword: any;
    passwordButton_NewPassword: any;
    passwordButton_confirm_NewPassword: any;
    ...
    ngOnInit() {
        ...
        this.passwordButton_OldPassword = {
            ...
            type: "default",
            onClick: () => {
                this.passwordMode_OldPassword = this.passwordMode_OldPassword === "text" ? "password" : "text";
            }
        };
