...
@Component({
  selector: 'app-kaalidrushti-free-data',
  templateUrl: './kaalidrushti-free-data.component.html',
  styleUrls: ['./kaalidrushti-free-data.component.scss']
})

export class KaalidrushtiFreeDataComponent {
  Name: string;
  horoInfo: any;
