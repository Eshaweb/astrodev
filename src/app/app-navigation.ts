export const navigationAfterLoginForAdmin = [
  {text: 'Home',path:'/home',icon: 'home'},
  {
    ...
    items: [{text: 'Horoscope',path: '/horoscope'},
      ...
      // { text: 'Baby Naming', path: '/babyNaming' },
      // { text: 'Kaalidrushti', path: '/kaalidrushti' },
      // { text: 'Prathamartava Guna-Dosha', path: '/prathamartava' },
...
export const navigationBeforeLogin = [
  ...
  {text: 'Registration',path:'/registration/id',icon: 'user'},
...
export const services = [{ text: 'Horoscope',path: '/horoscope'},
    ...
    //{Path: '/babyNaming',Name: 'Baby Naming'}
  ];
